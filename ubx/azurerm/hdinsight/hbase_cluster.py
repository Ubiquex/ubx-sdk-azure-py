...
class HbaseCluster_ComponentVersion:
    hbase: Any = None

@dataclasses.dataclass
class HbaseCluster_ComputeIsolation:
    compute_isolation_enabled: Any = None
    host_sku: Any = None

@dataclasses.dataclass
class HbaseCluster_DiskEncryption:
...
@dataclasses.dataclass
class HbaseCluster_Extension:
    log_analytics_workspace_id: Any = None
    primary_key: Any = None

@dataclasses.dataclass
class HbaseCluster_Gateway:
    password: Any = None
    username: Any = None

@dataclasses.dataclass
class HbaseCluster_Metastores_Ambari:
...
@dataclasses.dataclass
class HbaseCluster_Metastores:
    ambari: Any = None
    hive: Any = None
    oozie: Any = None

@dataclasses.dataclass
class HbaseCluster_Network:
    connection_direction: Any = None
    private_link_enabled: Any = None

@dataclasses.dataclass
class HbaseCluster_PrivateLinkConfiguration_IpConfiguration:
    name: Any = None
    primary: Any = None
...
@dataclasses.dataclass
class HbaseCluster_PrivateLinkConfiguration:
    group_id: Any = None
    name: Any = None
    ip_configuration: Any = None

@dataclasses.dataclass
class HbaseCluster_Roles_HeadNode_ScriptActions:
    name: Any = None
    parameters: Any = None
    uri: Any = None

@dataclasses.dataclass
class HbaseCluster_Roles_HeadNode:
    password: Any = None
    ssh_keys: Any = None
    subnet_id: Any = None
    username: Any = None
...
@dataclasses.dataclass
class HbaseCluster_Roles_WorkerNode_Autoscale_Recurrence_Schedule:
    days: Any = None
    target_instance_count: Any = None
    time: Any = None

@dataclasses.dataclass
class HbaseCluster_Roles_WorkerNode_Autoscale_Recurrence:
    timezone: Any = None
    schedule: Any = None

@dataclasses.dataclass
class HbaseCluster_Roles_WorkerNode_Autoscale:
    recurrence: Any = None

@dataclasses.dataclass
class HbaseCluster_Roles_WorkerNode:
    password: Any = None
    ssh_keys: Any = None
    subnet_id: Any = None
    target_instance_count: Any = None
...
@dataclasses.dataclass
class HbaseCluster_Roles:
    head_node: Any = None
    worker_node: Any = None
    zookeeper_node: Any = None

@dataclasses.dataclass
class HbaseCluster_SecurityProfile:
...
@dataclasses.dataclass
class HbaseCluster_StorageAccount:
    is_default: Any = None
...
@dataclasses.dataclass
class HbaseCluster_StorageAccountGen2:
...
@dataclasses.dataclass
class HbaseCluster_Timeouts:
    create: Any = None
    delete: Any = None
    read: Any = None
    update: Any = None

_HbaseCluster_ComponentVersionFields = {
    "hbase": sdk.FieldSpec(wire_name="hbase"),
}

_HbaseCluster_ComputeIsolationFields = {
    "compute_isolation_enabled": sdk.FieldSpec(wire_name="compute_isolation_enabled"),
    "host_sku": sdk.FieldSpec(wire_name="host_sku"),
}

_HbaseCluster_DiskEncryptionFields = {
...
_HbaseCluster_MetastoresFields = {
    "ambari": sdk.FieldSpec(
        wire_name="ambari",
        kind="list",
        fields=_HbaseCluster_Metastores_AmbariFields,
    ),
    "hive": sdk.FieldSpec(
        wire_name="hive",
        kind="list",
...
_HbaseCluster_PrivateLinkConfiguration_IpConfigurationFields = {
...
_HbaseCluster_PrivateLinkConfigurationFields = {
    "group_id": sdk.FieldSpec(wire_name="group_id"),
    "name": sdk.FieldSpec(wire_name="name"),
    "ip_configuration": sdk.FieldSpec(
        wire_name="ip_configuration",
        kind="list",
        fields=_HbaseCluster_PrivateLinkConfiguration_IpConfigurationFields,
    ),
}

_HbaseCluster_Roles_HeadNode_ScriptActionsFields = {
    "name": sdk.FieldSpec(wire_name="name"),
    "parameters": sdk.FieldSpec(wire_name="parameters"),
    "uri": sdk.FieldSpec(wire_name="uri"),
}

_HbaseCluster_Roles_HeadNodeFields = {
    "password": sdk.FieldSpec(wire_name="password"),
    ...
    "script_actions": sdk.FieldSpec(
        ...
        kind="list",
        fields=_HbaseCluster_Roles_HeadNode_ScriptActionsFields,
    ),
}

_HbaseCluster_Roles_WorkerNode_Autoscale_Recurrence_ScheduleFields = {
...
_HbaseCluster_Roles_WorkerNode_Autoscale_RecurrenceFields = {
    "timezone": sdk.FieldSpec(wire_name="timezone"),
    "schedule": sdk.FieldSpec(
        wire_name="schedule",
        kind="list",
        fields=_HbaseCluster_Roles_WorkerNode_Autoscale_Recurrence_ScheduleFields,
    ),
}

_HbaseCluster_Roles_WorkerNode_AutoscaleFields = {
    "recurrence": sdk.FieldSpec(
        wire_name="recurrence",
        kind="list",
        fields=_HbaseCluster_Roles_WorkerNode_Autoscale_RecurrenceFields,
    ),
}

_HbaseCluster_Roles_WorkerNodeFields = {
    "password": sdk.FieldSpec(wire_name="password"),
    "ssh_keys": sdk.FieldSpec(wire_name="ssh_keys"),
    "subnet_id": sdk.FieldSpec(wire_name="subnet_id"),
    "target_instance_count": sdk.FieldSpec(wire_name="target_instance_count"),
    ...
    "autoscale": sdk.FieldSpec(
        wire_name="autoscale",
        kind="list",
        fields=_HbaseCluster_Roles_WorkerNode_AutoscaleFields,
    ),
    "script_actions": sdk.FieldSpec(
        wire_name="script_actions",
        kind="list",
...
_HbaseCluster_RolesFields = {
    "head_node": sdk.FieldSpec(
        wire_name="head_node",
        kind="list",
        fields=_HbaseCluster_Roles_HeadNodeFields,
    ),
    "worker_node": sdk.FieldSpec(
        wire_name="worker_node",
        kind="list",
        fields=_HbaseCluster_Roles_WorkerNodeFields,
    ),
...
_HbaseCluster_SecurityProfileFields = {
...
_HbaseCluster_StorageAccountFields = {
...
_HbaseCluster_StorageAccountGen2Fields = {
...
HbaseCluster = sdk.ResourceBinding(
    wire_type="azurerm_hdinsight_hbase_cluster",
    fields={
        ...
        "component_version": sdk.FieldSpec(
            ...
            kind="list",
            fields=_HbaseCluster_ComponentVersionFields,
        ),
        "compute_isolation": sdk.FieldSpec(
            wire_name="compute_isolation",
            kind="list",
            fields=_HbaseCluster_ComputeIsolationFields,
        ),
        "disk_encryption": sdk.FieldSpec(
            wire_name="disk_encryption",
            kind="list",
            fields=_HbaseCluster_DiskEncryptionFields,
        ),
        "extension": sdk.FieldSpec(
            wire_name="extension",
            kind="list",
            fields=_HbaseCluster_ExtensionFields,
        ),
        "gateway": sdk.FieldSpec(
            wire_name="gateway",
            kind="list",
            fields=_HbaseCluster_GatewayFields,
        ),
        "metastores": sdk.FieldSpec(
            wire_name="metastores",
            kind="list",
            fields=_HbaseCluster_MetastoresFields,
        ),
        ...
        "network": sdk.FieldSpec(
            wire_name="network",
            kind="list",
            fields=_HbaseCluster_NetworkFields,
        ),
        "private_link_configuration": sdk.FieldSpec(
            wire_name="private_link_configuration",
            kind="list",
            fields=_HbaseCluster_PrivateLinkConfigurationFields,
        ),
        "roles": sdk.FieldSpec(
            wire_name="roles",
            kind="list",
            fields=_HbaseCluster_RolesFields,
        ),
        "security_profile": sdk.FieldSpec(
            wire_name="security_profile",
            kind="list",
            fields=_HbaseCluster_SecurityProfileFields,
        ),
        "storage_account": sdk.FieldSpec(
            wire_name="storage_account",
            kind="list",
            fields=_HbaseCluster_StorageAccountFields,
        ),
        "storage_account_gen2": sdk.FieldSpec(
            wire_name="storage_account_gen2",
            kind="list",
            fields=_HbaseCluster_StorageAccountGen2Fields,
        ),
        "timeouts": sdk.FieldSpec(
            wire_name="timeouts",
            kind="object",
            fields=_HbaseCluster_TimeoutsFields,
        ),
    },
)
