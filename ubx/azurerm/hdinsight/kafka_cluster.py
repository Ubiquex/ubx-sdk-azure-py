...
@dataclasses.dataclass
class KafkaCluster_ComputeIsolation:
    compute_isolation_enabled: Any = None
    host_sku: Any = None

@dataclasses.dataclass
class KafkaCluster_DiskEncryption:
...
@dataclasses.dataclass
class KafkaCluster_Extension:
    log_analytics_workspace_id: Any = None
    primary_key: Any = None

@dataclasses.dataclass
class KafkaCluster_Gateway:
    password: Any = None
    username: Any = None

@dataclasses.dataclass
class KafkaCluster_Metastores_Ambari:
...
@dataclasses.dataclass
class KafkaCluster_Metastores:
    ambari: Any = None
    hive: Any = None
    oozie: Any = None

@dataclasses.dataclass
class KafkaCluster_Network:
    connection_direction: Any = None
    private_link_enabled: Any = None

@dataclasses.dataclass
class KafkaCluster_PrivateLinkConfiguration_IpConfiguration:
    name: Any = None
    primary: Any = None
...
@dataclasses.dataclass
class KafkaCluster_PrivateLinkConfiguration:
    group_id: Any = None
    name: Any = None
    ip_configuration: Any = None

@dataclasses.dataclass
class KafkaCluster_RestProxy:
    security_group_id: Any = None
    security_group_name: Any = None

@dataclasses.dataclass
class KafkaCluster_Roles_HeadNode_ScriptActions:
    name: Any = None
    parameters: Any = None
    uri: Any = None

@dataclasses.dataclass
class KafkaCluster_Roles_HeadNode:
    password: Any = None
    ssh_keys: Any = None
    subnet_id: Any = None
    username: Any = None
...
@dataclasses.dataclass
class KafkaCluster_Roles_WorkerNode:
    number_of_disks_per_node: Any = None
    password: Any = None
    ssh_keys: Any = None
    subnet_id: Any = None
...
@dataclasses.dataclass
class KafkaCluster_Roles:
    head_node: Any = None
    kafka_management_node: Any = None
    worker_node: Any = None
    zookeeper_node: Any = None

@dataclasses.dataclass
class KafkaCluster_SecurityProfile:
...
@dataclasses.dataclass
class KafkaCluster_StorageAccount:
    is_default: Any = None
...
@dataclasses.dataclass
class KafkaCluster_StorageAccountGen2:
