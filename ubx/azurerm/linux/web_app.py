...
class WebApp_SiteConfig_ApplicationStack:
    ...
    go_version: Any = None
    java_server: Any = None
    java_server_version: Any = None
...
_WebApp_SiteConfig_ApplicationStackFields = {
    ...
    "go_version": sdk.FieldSpec(wire_name="go_version"),
    "java_server": sdk.FieldSpec(wire_name="java_server"),
    "java_server_version": sdk.FieldSpec(wire_name="java_server_version"),
    ...
    "python_version": sdk.FieldSpec(wire_name="python_version"),
}
...
class WebAppConfig:
    ...
    virtual_network_subnet_id: Any = None
    vnet_image_pull_enabled: Any = None
...
WebApp = sdk.ResourceBinding(
    wire_type="azurerm_linux_web_app",
    fields={
        ...
        "virtual_network_subnet_id": sdk.FieldSpec(wire_name="virtual_network_subnet_id"),
        "vnet_image_pull_enabled": sdk.FieldSpec(wire_name="vnet_image_pull_enabled"),
