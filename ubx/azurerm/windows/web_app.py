...
_WebApp_StickySettingsFields = {
    "app_setting_names": ubx.FieldSpec(wire_name="app_setting_names"),
    "connection_string_names": ubx.FieldSpec(wire_name="connection_string_names"),
}
