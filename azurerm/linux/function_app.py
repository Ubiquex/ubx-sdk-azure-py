...
class FunctionApp_AuthSettings_ActiveDirectory:
...
@dataclasses.dataclass
class FunctionApp_AuthSettings_Facebook:
    app_id: Any = None
    app_secret: Any = None
...
@dataclasses.dataclass
class FunctionApp_AuthSettings_Github:
    client_id: Any = None
    client_secret: Any = None
    client_secret_setting_name: Any = None
    oauth_scopes: Any = None
...
@dataclasses.dataclass
class FunctionApp_AuthSettingsV2_ActiveDirectoryV2:
...
@dataclasses.dataclass
class FunctionApp_AuthSettingsV2_AppleV2:
    client_id: Any = None
    client_secret_setting_name: Any = None
    login_scopes: Any = None

@dataclasses.dataclass
class FunctionApp_AuthSettingsV2_AzureStaticWebAppV2:
    client_id: Any = None

@dataclasses.dataclass
class FunctionApp_AuthSettingsV2_CustomOidcV2:
...
@dataclasses.dataclass
class FunctionApp_AuthSettingsV2_FacebookV2:
    app_id: Any = None
    app_secret_setting_name: Any = None
...
@dataclasses.dataclass
class FunctionApp_AuthSettingsV2_GoogleV2:
    allowed_audiences: Any = None
    client_id: Any = None
    client_secret_setting_name: Any = None
    login_scopes: Any = None
...
@dataclasses.dataclass
class FunctionApp_AuthSettingsV2_Login:
    allowed_external_redirect_urls: Any = None
...
@dataclasses.dataclass
class FunctionApp_AuthSettingsV2_TwitterV2:
    consumer_key: Any = None
    consumer_secret_setting_name: Any = None

@dataclasses.dataclass
class FunctionApp_AuthSettingsV2:
...
@dataclasses.dataclass
class FunctionApp_Backup_Schedule:
...
@dataclasses.dataclass
class FunctionApp_ConnectionString:
    name: Any = None
    type: Any = None
    value: Any = None

@dataclasses.dataclass
class FunctionApp_Identity:
...
@dataclasses.dataclass
class FunctionApp_SiteConfig_AppServiceLogs:
    disk_quota_mb: Any = None
    retention_period_days: Any = None

@dataclasses.dataclass
class FunctionApp_SiteConfig_ApplicationStack_Docker:
    image_name: Any = None
    image_tag: Any = None
...
@dataclasses.dataclass
class FunctionApp_SiteConfig_ApplicationStack:
    dotnet_version: Any = None
    java_version: Any = None
    node_version: Any = None
    powershell_core_version: Any = None
    python_version: Any = None
    use_custom_runtime: Any = None
    use_dotnet_isolated_runtime: Any = None
    docker: Any = None

@dataclasses.dataclass
class FunctionApp_SiteConfig_Cors:
    allowed_origins: Any = None
    support_credentials: Any = None

@dataclasses.dataclass
class FunctionApp_SiteConfig_IpRestriction_Headers:
...
@dataclasses.dataclass
class FunctionApp_SiteConfig_IpRestriction:
    action: Any = None
...
@dataclasses.dataclass
class FunctionApp_StickySettings:
    app_setting_names: Any = None
    connection_string_names: Any = None

@dataclasses.dataclass
class FunctionApp_StorageAccount:
    access_key: Any = None
...
@dataclasses.dataclass
class FunctionApp_Timeouts:
    create: Any = None
    delete: Any = None
    read: Any = None
    update: Any = None

_FunctionApp_AuthSettings_ActiveDirectoryFields = {
...
_FunctionApp_AuthSettings_FacebookFields = {
...
_FunctionApp_AuthSettings_GithubFields = {
    "client_id": sdk.FieldSpec(wire_name="client_id"),
    "client_secret": sdk.FieldSpec(wire_name="client_secret"),
    "client_secret_setting_name": sdk.FieldSpec(wire_name="client_secret_setting_name"),
    "oauth_scopes": sdk.FieldSpec(wire_name="oauth_scopes"),
...
_FunctionApp_AuthSettings_TwitterFields = {
...
_FunctionApp_AuthSettingsFields = {
    ...
    "active_directory": sdk.FieldSpec(
        ...
        kind="list",
        fields=_FunctionApp_AuthSettings_ActiveDirectoryFields,
    ),
    "facebook": sdk.FieldSpec(
        wire_name="facebook",
        kind="list",
        fields=_FunctionApp_AuthSettings_FacebookFields,
    ),
    "github": sdk.FieldSpec(
        wire_name="github",
        kind="list",
        fields=_FunctionApp_AuthSettings_GithubFields,
    ),
    ...
    "twitter": sdk.FieldSpec(
        wire_name="twitter",
        kind="list",
        fields=_FunctionApp_AuthSettings_TwitterFields,
    ),
}

_FunctionApp_AuthSettingsV2_ActiveDirectoryV2Fields = {
...
_FunctionApp_AuthSettingsV2_AppleV2Fields = {
    "client_id": sdk.FieldSpec(wire_name="client_id"),
    "client_secret_setting_name": sdk.FieldSpec(wire_name="client_secret_setting_name"),
    "login_scopes": sdk.FieldSpec(wire_name="login_scopes"),
}

_FunctionApp_AuthSettingsV2_AzureStaticWebAppV2Fields = {
    "client_id": sdk.FieldSpec(wire_name="client_id"),
}

_FunctionApp_AuthSettingsV2_CustomOidcV2Fields = {
...
_FunctionApp_AuthSettingsV2_FacebookV2Fields = {
    "app_id": sdk.FieldSpec(wire_name="app_id"),
    "app_secret_setting_name": sdk.FieldSpec(wire_name="app_secret_setting_name"),
...
_FunctionApp_AuthSettingsV2_GoogleV2Fields = {
    "allowed_audiences": sdk.FieldSpec(wire_name="allowed_audiences"),
    "client_id": sdk.FieldSpec(wire_name="client_id"),
    "client_secret_setting_name": sdk.FieldSpec(wire_name="client_secret_setting_name"),
    "login_scopes": sdk.FieldSpec(wire_name="login_scopes"),
...
_FunctionApp_AuthSettingsV2_LoginFields = {
    "allowed_external_redirect_urls": sdk.FieldSpec(wire_name="allowed_external_redirect_urls"),
...
_FunctionApp_AuthSettingsV2_TwitterV2Fields = {
    "consumer_key": sdk.FieldSpec(wire_name="consumer_key"),
    "consumer_secret_setting_name": sdk.FieldSpec(wire_name="consumer_secret_setting_name"),
}

_FunctionApp_AuthSettingsV2Fields = {
    ...
    "active_directory_v2": sdk.FieldSpec(
        ...
        kind="list",
        fields=_FunctionApp_AuthSettingsV2_ActiveDirectoryV2Fields,
    ),
    "apple_v2": sdk.FieldSpec(
        wire_name="apple_v2",
        kind="list",
        fields=_FunctionApp_AuthSettingsV2_AppleV2Fields,
    ),
    "azure_static_web_app_v2": sdk.FieldSpec(
        wire_name="azure_static_web_app_v2",
        kind="list",
        fields=_FunctionApp_AuthSettingsV2_AzureStaticWebAppV2Fields,
    ),
    "custom_oidc_v2": sdk.FieldSpec(
        wire_name="custom_oidc_v2",
        kind="list",
        fields=_FunctionApp_AuthSettingsV2_CustomOidcV2Fields,
    ),
    "facebook_v2": sdk.FieldSpec(
        wire_name="facebook_v2",
        kind="list",
        fields=_FunctionApp_AuthSettingsV2_FacebookV2Fields,
    ),
    ...
    "google_v2": sdk.FieldSpec(
        wire_name="google_v2",
        kind="list",
        fields=_FunctionApp_AuthSettingsV2_GoogleV2Fields,
    ),
    "login": sdk.FieldSpec(
        wire_name="login",
        kind="list",
        fields=_FunctionApp_AuthSettingsV2_LoginFields,
    ),
    ...
    "twitter_v2": sdk.FieldSpec(
        ...
        kind="list",
        fields=_FunctionApp_AuthSettingsV2_TwitterV2Fields,
    ),
}

_FunctionApp_Backup_ScheduleFields = {
...
_FunctionApp_BackupFields = {
    ...
    "schedule": sdk.FieldSpec(
        wire_name="schedule",
        kind="list",
        fields=_FunctionApp_Backup_ScheduleFields,
    ),
}

_FunctionApp_ConnectionStringFields = {
    "name": sdk.FieldSpec(wire_name="name"),
    "type": sdk.FieldSpec(wire_name="type"),
    "value": sdk.FieldSpec(wire_name="value"),
}

_FunctionApp_IdentityFields = {
...
_FunctionApp_SiteConfig_AppServiceLogsFields = {
    "disk_quota_mb": sdk.FieldSpec(wire_name="disk_quota_mb"),
    "retention_period_days": sdk.FieldSpec(wire_name="retention_period_days"),
}

_FunctionApp_SiteConfig_ApplicationStack_DockerFields = {
    "image_name": sdk.FieldSpec(wire_name="image_name"),
    "image_tag": sdk.FieldSpec(wire_name="image_tag"),
...
_FunctionApp_SiteConfig_ApplicationStackFields = {
    ...
    "powershell_core_version": sdk.FieldSpec(wire_name="powershell_core_version"),
    "python_version": sdk.FieldSpec(wire_name="python_version"),
    "use_custom_runtime": sdk.FieldSpec(wire_name="use_custom_runtime"),
    "use_dotnet_isolated_runtime": sdk.FieldSpec(wire_name="use_dotnet_isolated_runtime"),
    "docker": sdk.FieldSpec(
        wire_name="docker",
        kind="list",
        fields=_FunctionApp_SiteConfig_ApplicationStack_DockerFields,
    ),
}

_FunctionApp_SiteConfig_CorsFields = {
    "allowed_origins": sdk.FieldSpec(wire_name="allowed_origins"),
    "support_credentials": sdk.FieldSpec(wire_name="support_credentials"),
}

_FunctionApp_SiteConfig_IpRestriction_HeadersFields = {
...
_FunctionApp_SiteConfig_IpRestrictionFields = {
    "action": sdk.FieldSpec(wire_name="action"),
    "description": sdk.FieldSpec(wire_name="description"),
    "headers": sdk.FieldSpec(
        wire_name="headers",
        kind="list",
        fields=_FunctionApp_SiteConfig_IpRestriction_HeadersFields,
    ),
...
_FunctionApp_SiteConfigFields = {
    ...
    "app_service_logs": sdk.FieldSpec(
        ...
        kind="list",
        fields=_FunctionApp_SiteConfig_AppServiceLogsFields,
    ),
    "application_stack": sdk.FieldSpec(
        wire_name="application_stack",
        kind="list",
        fields=_FunctionApp_SiteConfig_ApplicationStackFields,
    ),
    "cors": sdk.FieldSpec(
        wire_name="cors",
        kind="list",
        fields=_FunctionApp_SiteConfig_CorsFields,
    ),
    "ip_restriction": sdk.FieldSpec(
        wire_name="ip_restriction",
        kind="list",
        fields=_FunctionApp_SiteConfig_IpRestrictionFields,
    ),
...
_FunctionApp_StickySettingsFields = {
...
_FunctionApp_StorageAccountFields = {
...
class FunctionAppConfig:
    ...
    storage_uses_managed_identity: Any = None
    tags: Any = None
...
FunctionApp = sdk.ResourceBinding(
    wire_type="azurerm_linux_function_app",
    fields={
        "app_settings": sdk.FieldSpec(wire_name="app_settings"),
        "builtin_logging_enabled": sdk.FieldSpec(wire_name="builtin_logging_enabled"),
        ...
        "content_share_force_disabled": sdk.FieldSpec(wire_name="content_share_force_disabled"),
        "daily_memory_time_quota": sdk.FieldSpec(wire_name="daily_memory_time_quota"),
        "enabled": sdk.FieldSpec(wire_name="enabled"),
        "ftp_publish_basic_authentication_enabled": sdk.FieldSpec(wire_name="ftp_publish_basic_authentication_enabled"),
        "functions_extension_version": sdk.FieldSpec(wire_name="functions_extension_version"),
        ...
        "storage_uses_managed_identity": sdk.FieldSpec(wire_name="storage_uses_managed_identity"),
        ...
        "auth_settings": sdk.FieldSpec(
            ...
            kind="list",
            fields=_FunctionApp_AuthSettingsFields,
        ),
        "auth_settings_v2": sdk.FieldSpec(
            wire_name="auth_settings_v2",
            kind="list",
            fields=_FunctionApp_AuthSettingsV2Fields,
        ),
        "backup": sdk.FieldSpec(
            wire_name="backup",
            kind="list",
            fields=_FunctionApp_BackupFields,
        ),
        "connection_string": sdk.FieldSpec(
            wire_name="connection_string",
            kind="set",
            fields=_FunctionApp_ConnectionStringFields,
        ),
        "identity": sdk.FieldSpec(
            wire_name="identity",
            kind="list",
            fields=_FunctionApp_IdentityFields,
        ),
        "site_config": sdk.FieldSpec(
            wire_name="site_config",
            kind="list",
            fields=_FunctionApp_SiteConfigFields,
        ),
        "sticky_settings": sdk.FieldSpec(
            wire_name="sticky_settings",
            kind="list",
            fields=_FunctionApp_StickySettingsFields,
        ),
        "storage_account": sdk.FieldSpec(
            wire_name="storage_account",
            kind="set",
            fields=_FunctionApp_StorageAccountFields,
        ),
        "timeouts": sdk.FieldSpec(
            wire_name="timeouts",
            kind="object",
            fields=_FunctionApp_TimeoutsFields,
        ),
    },
)
