...
@dataclasses.dataclass
class ProtectionBackupPolicyMysqlFlexibleServer_DefaultRetentionRule:
    life_cycle: Any = None

@dataclasses.dataclass
class ProtectionBackupPolicyMysqlFlexibleServer_RetentionRule_Criteria:
...
@dataclasses.dataclass
class ProtectionBackupPolicyMysqlFlexibleServer_RetentionRule:
    name: Any = None
    priority: Any = None
    criteria: Any = None
    life_cycle: Any = None
...
@dataclasses.dataclass
class ProtectionBackupPolicyMysqlFlexibleServer_Timeouts:
    create: Any = None
    delete: Any = None
    read: Any = None
...
@dataclasses.dataclass
class ProtectionBackupPolicyMysqlFlexibleServerConfig:
