...
class FactoryLinkedServicePostgresql_Timeouts:
    create: Any = None
    delete: Any = None
    read: Any = None
    update: Any = None

_FactoryLinkedServicePostgresql_TimeoutsFields = {
...
@dataclasses.dataclass
class FactoryLinkedServicePostgresqlConfig:
...
FactoryLinkedServicePostgresql = sdk.ResourceBinding(
    wire_type="azurerm_data_factory_linked_service_postgresql",
    fields={
        ...
        "timeouts": sdk.FieldSpec(
            wire_name="timeouts",
            kind="object",
            fields=_FactoryLinkedServicePostgresql_TimeoutsFields,
        ),
    },
)
